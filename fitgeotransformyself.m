function [tform,jumpupflag] = fitgeotransformyself(movingPoints,fixedPoints,transformationType,optionalArg)
...
switch transformationType
    ...
    case 'projective'
        ...
        [tform,jumpupflag] = findProjectiveTransform(movingPoints,fixedPoints);
...
function [tform,jumpupflag] = findProjectiveTransform(uv,xy)
%
